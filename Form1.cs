...
namespace CPower_CSharp
{
    public partial class Form1 : Form
    {
        ...
        {
             PRG = CP5200.CP5200_Program_Create(96, 16, 2);
        }

        private void AddPRGText_Click(object sender, EventArgs e)
        {
            CP5200.CP5200_Add_Text(PRG, 0, "this is a string", 1, Color.FromArgb(255, 0, 0).ToArgb(), 1, 1, 5);

            CP5200.CP5200_Add_Text(PRG, 0, "this a string too ! ", 1, Color.FromArgb(255, 0, 0).ToArgb(), 1, 1, 5);
        }

        private void RunPRG_Click(object sender, EventArgs e)
        {
